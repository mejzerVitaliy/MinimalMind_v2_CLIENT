...
const HomeContent = () => {
    return (
        <main className='w-full h-[calc(100vh-100px-70px)] flex justify-center items-center p-4'>
            <section className=' p-2 flex-1 bg-yellow-800 rounded-tl-xl rounded-br-xl'>
